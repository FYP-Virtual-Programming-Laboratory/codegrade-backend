...
def upgrade():
    ...
    op.create_table('excercisesubmission',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True),
    sa.Column('external_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_excercisesubmission_external_id'), 'excercisesubmission', ['external_id'], unique=True)
    ...
    sa.ForeignKeyConstraint(['submission_id'], ['excercisesubmission.id'], ),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_excercisesubmission_external_id'), table_name='excercisesubmission')
    op.drop_table('excercisesubmission')
